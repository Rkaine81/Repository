...
#return $outTeamsVersion.type

if (($outTeamsVersion.type) -contains "New Teams" -and ($outTeamsVersion.type) -contains "Teams Classic") {write-output "Both Types Present"}
if (($outTeamsVersion.type) -contains "New Teams" -and ($outTeamsVersion.type) -notcontains "Teams Classic") {write-output "New Teams"}
if (($outTeamsVersion.type) -notcontains "New Teams" -and ($outTeamsVersion.type) -contains "Teams Classic") {write-output "Teams Classic"}