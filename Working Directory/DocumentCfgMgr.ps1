...
Param(
    ...
    [string]$CompanyName = "Childrens Healthcareof Atlanta",
    
    [parameter(Mandatory=$False)] 
    [string]$CompanyLogo = "\\choa-cifs\install\CM_P01\00_ToolsTestTemplates\choalogo1.png",
    ...
    [parameter(Mandatory=$False)] 
    [string]$Author="Adam Eaddy",

    [parameter(Mandatory=$False)] 
    [string]$Vendor = "Childrens Healthcareof Atlanta",
    ...
    [parameter(Mandatory=$False)] 
    [string]$SMSProvider='dcvwp-sccmsup01',
