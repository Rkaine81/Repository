...
$dirA = "C:\CHOA\IST\Event Management Resources"
$dirB = (pwd).Path
...
If (test-path "C:\CHOA\IST\Event Management Resources\copy-SharePointFiles.ps1") {
    remove-item "C:\CHOA\IST\Event Management Resources\copy-SharePointFiles.ps1" -Force
}