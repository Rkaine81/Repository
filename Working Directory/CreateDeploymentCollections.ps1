...
Description: The purpose of this script is to create device collections for projects that need randomized, phased deployments. (* indicates this value is required.)
             ...
             6. Create a folder and move the collections into the folder located at: DeviceCollection"\Workstation Collections\Targeted Deployments".
...
Example: 
Example 1: CreateDeploymentCollections.ps1 -nbcuCollectionName "CHG000001 - New Project" -groupSize 3000 -sourceCollectionID CAS0064A -exclusionCollectionID CAS00000
