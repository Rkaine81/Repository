...
$LOGPATH = $env:TEMP
#Set Log name
$LOGFILE = "XX_$SDATE.log"
$FULLLOGPATH = "$LOGPATH\$LOGFILE"

# Set the current location to be the site code.
Set-Location "$($SiteCodeCAS):\" @initParams

Get-CMStatusMessageQuery -Name "All Audit Status Messages from a Specific Site" -ShowMessage

Get-CMStatusMessageQuery -Name *Audit* | Export-Clixml C:\temp\Audit_StatusMsgQueries.xml

get-cmsitestatusmessage -SiteCode $SiteCodeCAS -MessageId 30016